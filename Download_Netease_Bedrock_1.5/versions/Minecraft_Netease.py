...
class Frame(wx.Frame):
    def __init__(self):
        wx.Frame.__init__(self, None, title='网易我的世界基岩版下载地址获取器v1.5(By daijunhao),(github:daijunhaoMinecraft),仅供学习交流,严禁用于商业用途,请于24小时内删除', size=(950, 670),name='frame',style=541072384)
